...
data class Topics(
    ...
    data class CoverPhoto(
        ...
        data class Links(
            ...
            val html: String?,
            val download: String?,
            @SerializedName("") val downloadLocation: String?,
        ) : Parcelable
        ...
        data class User(
            ...
            @SerializedName("last_name") val lastName: String?,
            @SerializedName("twitter_username") val twitterUsername: String?,
            @SerializedName("portfoilo_url") val portfolioUrl: String?,
            val bio: String?,
            val location: String?,
            val links: Links?,
            @SerializedName("profile_image") val profileImage: ProfileImage?,
            @SerializedName("instagra_username") val instagramUsername: String?,
            @SerializedName("total_collections") val totalCollections: Int?,
            @SerializedName("total_likes") val totalLikes: Int?,
            @SerializedName("total_photos") val totalPhotos: Int?,
            @SerializedName("accepted_tos") val acceptedTos: Boolean?,
